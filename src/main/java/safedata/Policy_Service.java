 ...
 * 
 */
@WebServiceClient(name = "Policy", targetNamespace = "http://policy.apiV2.server.backup.r1soft.com/", wsdlLocation = "file:E:\\intellij\\safedata\\src\\main\\resources\\view-source_safedata1.r1soft.ro_9080_Policy2_wsdl.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:E:\\intellij\\safedata\\src\\main\\resources\\view-source_safedata1.r1soft.ro_9080_Policy2_wsdl.wsdl");
